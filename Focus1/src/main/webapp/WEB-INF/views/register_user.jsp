...
<body>
  ...
  <form:form  commandName ="candidate" action="Candidatesubmitsignup" method="POST"  id="for" onsubmit="return validate();" >
    ...
    <div class="contentform">
    	...
    	<div class="leftcontact">
            ...
            <span class="icon-case"><i class="fa fa-user"></i></span>
				<form:input path ="name.middleName" type="text" name="name.middleName"  data-rule="required" data-msg="Enter the field"/>
	...
	<div class="rightcontact">	
		   ...
		   <div class="form-group">
			...
			<span class="icon-case"><i class="fa fa-comment-o"></i></span>
                <form:input type="number" name="address.zip"  path="address.zip" data-rule="required" data-msg="Enter the field" pattern="/\d{5}/"/>
