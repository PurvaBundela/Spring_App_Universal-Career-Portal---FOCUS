...
<body>
	    ...
	    <div class="container">
	       	<div class="row">
	            ...
	            <div class="col-md-9">
	            <form:form commandName="employee" action="submitUpdatedEmployee" method="POST" onsubmit="return validate();">
			...
			<tr >
				...
				<td>
					<div class="col-md-10">
						...
						<form:input path="name.firstName" cssClass="form-control" name="fistName" required="required"/>
					</div>
				</td>
			</tr>
			<tr >
				...
				<td>
					<div class="col-md-10">
						<form:input path="name.middleName" cssClass="form-control" name="middleName"/>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="col-md-10">
						<form:input path="name.lastName" cssClass="form-control" name="lastName"/>
					</div>
				</td>
			</tr>
			<tr>
