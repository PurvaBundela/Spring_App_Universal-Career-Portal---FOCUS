		...
		<header id="fh5co-header-section" role="header" class="" >
			<div class="container">
				...
				<!-- <div id="fh5co-menu-logo"> -->
					<!-- START #fh5co-logo -->
					<h1 id="fh5co-logo" class="pull-left"><a href="index.html"><img src="resources/assets/images/logo1.png" alt="Slant Free HTML5 Template"></a></h1>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							...
							<p class="to-animate hero-animate-3"><a href="/focus/" class="btn btn-outline btn-lg">SORRY INVALID LOGIN CREDENTIALS, PLEASE LOGIN AGAIN!!</a></p>
						</div>
					</div>
				</div>
			</div>		
